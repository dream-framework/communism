...
Формат ответа:
4–5 кратких пунктов (по одному предложению в пункте) с основными фактами. Пункты не нумеруй, а формируй отдельными параграфами. Начинай текст заголовком, отражающим суть материала
