...
Формат ответа:
4–5 кратких пунктов (по 2-3 предложения в пункте) с основными фактами. Пункты не нумеруй, а формируй отдельными параграфами. Начинай текст заголовком, отражающим суть материала, всегда переведенном на русский. 
